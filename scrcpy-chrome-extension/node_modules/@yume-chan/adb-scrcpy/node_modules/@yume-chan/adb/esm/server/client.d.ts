...
export declare class AdbServerClient {
     ...
     * `adb version`
     */
    getVersion(options?: AdbServerClient.ServerConnectionOptions): Promise<number>;
    validateVersion(minimalVersion: number, options?: AdbServerClient.ServerConnectionOptions): Promise<void>;
    /**
     * `adb kill-server`
     */
     ...
     */
    createDeviceConnection(device: AdbServerClient.DeviceSelector, service: string, options?: AdbServerClient.ServerConnectionOptions): Promise<AdbServerClient.Socket>;
    /**
