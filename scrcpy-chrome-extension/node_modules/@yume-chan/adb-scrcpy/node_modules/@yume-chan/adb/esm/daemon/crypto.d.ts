...
export declare function rsaParsePrivateKey(key: Uint8Array): SimpleRsaPrivateKey;
...
export declare function rsaSign(privateKey: SimpleRsaPrivateKey, data: Uint8Array): Uint8Array<ArrayBuffer>;
