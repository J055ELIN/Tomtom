...
function parseDeviceLineItem(line, end, key, optional) {
    ...
    return [start, line.substring(start + key.length, end)];
}
/**
...
export class AdbServerClient {
    ...
    async validateVersion(minimalVersion, options) {
     ...
     */
    async createDeviceConnection(device, service, options) {
        let switchService;
        let transportId;
        if (!device) {
