...
export declare class AdbDaemonSocketController implements AdbDaemonSocketInfo, Adb.Socket, Disposable {
    #private;
 ...
 */
export declare class AdbDaemonSocket implements AdbDaemonSocketInfo, Adb.Socket {
    #private;
    get localId(): number;
    get remoteId(): number;
