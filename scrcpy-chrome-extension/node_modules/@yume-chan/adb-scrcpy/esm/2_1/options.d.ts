...
export declare class AdbScrcpyOptions2_1<TInit extends ScrcpyOptions2_1.Init = ScrcpyOptions2_1.Init> extends ScrcpyOptions2_1<TInit> implements AdbScrcpyOptions<ScrcpyOptions2_1.Value<TInit>>, AdbScrcpyOptionsGetEncoders {
...
export declare namespace AdbScrcpyOptions2_1 {
    type Init = ScrcpyOptions2_1.Init;
}
