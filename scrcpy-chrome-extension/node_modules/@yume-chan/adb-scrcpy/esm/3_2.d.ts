...
export declare class AdbScrcpyOptions3_2<TInit extends ScrcpyOptions3_2.Init = ScrcpyOptions3_2.Init> extends ScrcpyOptions3_2<TInit> implements AdbScrcpyOptions<ScrcpyOptions3_2.Value<TInit>>, AdbScrcpyOptionsGetEncoders {
...
export declare namespace AdbScrcpyOptions3_2 {
    type Init = ScrcpyOptions3_2.Init;
}
