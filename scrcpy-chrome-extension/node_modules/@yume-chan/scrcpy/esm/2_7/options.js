...
export class ScrcpyOptions2_7 {
    ...
    parseVideoStreamMetadata(stream) {
        return parseVideoStreamMetadata(stream, this.value.sendDeviceMeta, this.value.sendCodecMeta, parseVideoCodecOption(this.value.videoCodec), parseVideoStreamMetadataAsync);
    }
    parseAudioStreamMetadata(stream) {
        return parseAudioStreamMetadata(stream, this.value.sendCodecMeta, parseAudioMetadataCodec, parseAudioCodecOption(this.value.audioCodec));
    }
