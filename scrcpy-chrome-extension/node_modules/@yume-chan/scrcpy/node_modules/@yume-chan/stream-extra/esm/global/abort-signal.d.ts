import type { AddEventListenerOptions, Event, EventListenerOptions, EventListenerOrEventListenerObject } from "./event.js";
...
interface _AbortSignal {
    ...
    removeEventListener<K extends keyof AbortSignalEventMap>(type: K, listener: (this: AbortSignal, ev: AbortSignalEventMap[K]) => void, options?: boolean | EventListenerOptions): void;
...
export declare const AbortSignal: NonNullable<AbortSignalConstructor>;
/**
...
export declare const AbortController: NonNullable<AbortControllerConstructor>;
export {};
